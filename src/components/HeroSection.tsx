...
const HeroSection = () => {
  return (
    <div className="relative text-center py-24 px-4 bg-white">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <p className="text-xl md:text-2xl text-red-400 mb-8 max-w-3xl mx-auto animate-slide-up">
        ...
        <div className="flex justify-center space-x-4 animate-fade-in" style={{ animationDelay: '0.6s' }}>
          <div className="px-4 py-2 bg-red-50 backdrop-blur-sm border border-red-200 rounded-full">
      ...
      <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-red-500 opacity-3 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-red-600 opacity-3 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
    </div>
  );
};
